...
class WakeWordManager {
    ...
    startListening() {
        ...
        // Create new recognition instance each time to avoid conflicts
        ...
        this.recognition.onerror = (event) => {
            ...
            // Don't restart on 'aborted' - it usually means another recognition started
            // or the browser stopped us intentionally
            if (event.error === 'aborted') {
                console.log('Wake word recognition aborted (likely by main speech recognition)');
                return;
            }
